        ...
        while True:
            try:
                ...
                if response.status_code != 200:
                    ...
                    with open("assets/application data/GameDetails.json", "w") as game_details_json_file:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                with open("assets/application data/IdentifyDeviceDetails.json", "w") as identify_device_details_json_file:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                with open("assets/application data/device configurations.json", "w") as device_config_json_file:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                with open("assets/application data/GameClue.json", "w") as game_clue_json_file:
