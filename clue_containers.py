...
class ClueVideoWidget(QWidget):
    ...
    def frontend(self):
        ...
        default = "assets/clue medias/" + self.initial_file_name
...
class AudioClueContainer(QWidget):
    ...
    def frontend(self):
        ...
        default = "assets/clue medias/" + self.file
...
class ClueWindow(QWidget):
    ...
    def frontend(self):
        ...
        try:
            with open("assets/application data/GameClue.json") as game_clue_json_file:
    ...
    def master_text_clue_container(self, text):
        ...
        self.notify_audio_player.play("assets/MessageAlert.mp3")
    ...
    def master_image_clue_container(self, file_name):
        ...
        default = "assets/clue medias/" + file_name
