...
class SplashBackend(QThread):
    ...
    def run(self):
        ...
        # cluemaster_service = autostart.AutoStartFunctionality()
        print(os.getcwd())
        ...
        if os.path.isfile(os.path.join("assets/application data", "unique code.json")):
            ...
            while self.is_killed is False:
                ...
                try:
                    ...
                    with open("assets/application data/unique code.json", "w") as unique_code_json_file:
...
def main():
    ...
    application.setApplicationVersion("0.4.4")
