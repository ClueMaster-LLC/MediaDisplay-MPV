...
class SplashBackend(QThread):
    ...
    def run(self):
        ...
        if os.path.isdir(os.path.join(MASTER_DIRECTORY, "assets/application data")) is False:
            ...
            try:
                os.mkdir(os.path.join(MASTER_DIRECTORY))
            except FileExistsError:
                pass

            try:
                os.mkdir(os.path.join(MASTER_DIRECTORY, "assets"))
            except FileExistsError:
                pass

            try:
                os.mkdir(os.path.join(MASTER_DIRECTORY, "assets/application data"))
            except FileExistsError:
                pass
        ...
        if os.path.isfile(os.path.join(MASTER_DIRECTORY, "assets/application data", "unique code.json")):
            ...
            while self.is_killed is False:
                ...
                try:
                    ...
                    with open(os.path.join(MASTER_DIRECTORY, "assets/application data/unique code.json"), "w") as unique_code_json_file:
            ...
            with open(os.path.join(MASTER_DIRECTORY, "assets/application data", "unique code.json"), "w") as file:
...
def main():
    ...
    application.setApplicationVersion("0.4.7")
