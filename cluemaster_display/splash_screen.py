...
# Setting up environment variables (uncomment if warnings come up again)
...
class SplashWindow(QWidget):
    ...
    def switch_window(self, skip):
        ...
        if skip is True:
            ...
            from cluemaster_display import loading_screen
            ...
            if skip is False:
                ...
                from cluemaster_display import authentication_screen
