...
class ClueContainer(QWidget):
    ...
    def __init__(self):
        ...
        # widgets
        self.clue_icon_item = QPixmap("assets/icons/clue_icon.png")
        self.clue_icon_unavailable_item = QPixmap("assets/icons/clue_icon_unavailable.png")
    ...
    def update_clues_used(self, used):
        ...
        for icons in self.clue_icons_available[::-1]:
            if clues_used != clues_marked_used:
                ...
                icons.setOpacity(0.3, self.clue_icon_unavailable_item)
                clues_marked_used += 1
